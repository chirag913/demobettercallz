...
- The created demo agent uses Ritu at 1.0x speed, allows interruption and language switching, starts in Hindi, caps calls at three minutes, and disables voicemail messages.
