...
24 September follow-up: the source prompt now prioritizes the visitor's reason for trying BetterCallz. After the greeting, its preferred first substantive question is "So, what made you curious about BetterCallz?" It removes the immediate work question, prohibits manufactured small talk, follows test-only and question-first visitors, and gives explicit buying signals priority over further discovery. Published to Sarvam as committed version 10 after restoring the browser connection. Production is pinned to version 10. The committed editor was checked for the curiosity question and demo-first priority. Lint and TypeScript passed; no additional phone call was placed for this prompt revision.
